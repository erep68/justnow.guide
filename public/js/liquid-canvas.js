    ...
    liquidCanvas: function(func) {
      this.each(function() {
        ...
        if (window.G_vmlCanvasManager) {
          $(this).before('<div width="0" height="0" style="opacity: 0.30; -moz-opacity: 0.30; filter: alpha(opacity=30); position:absolute; top:0px; left:0px;"></div>');
          ...
          $(this).before('<canvas width="0" height="0" style="opacity: 0.30; -moz-opacity: 0.30; filter: alpha(opacity=30);position:absolute; top:0px; left:0px;"></canvas>');
