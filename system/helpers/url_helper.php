...
/**
 * Remove the http:// from a url.
 */
if ( ! function_exists('remove_http'))
{
	function remove_http($str = '')
	{
            $www = explode('http://',$str);
            return (sizeof($www)>1)? $www[1] : $www[0];
	}
}

if ( ! function_exists('remove_www'))
{
	function remove_www($str = '')
	{
            $www = explode('www.',$str);
            return (sizeof($www)>1)? $www[1] : $www[0];
	}
...
if ( ! function_exists('get_url'))
{
        function get_url(){
            ...
            if(get_subdomain() != 'www')
                $url = get_subdomain().'.'.remove_http(remove_www(base_url()));
            else
                $url = remove_http(base_url());
            return 'http://'.$url;
        }
}
// ------------------------------------------------------------------------
