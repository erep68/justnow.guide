...
<?php $data = array('id'=>'fomulari', 'class'=>'form_default', 'role' => 'form');
  ...
  <div class="input-group input-group-lg form_control">
      ...
      <input type="text" class="form-control input-lg " name="name" id="name" value="<?php echo $object->name;?>" placeholder="Nombre de la Categoria">
  </div>
  <textarea  cols = "50" rows = "5" class="form-control" name="description" id="description" placeholder="Descripción"><?php echo $object->description;?></textarea>
